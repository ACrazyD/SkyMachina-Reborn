...
event.recipes.gtceu.cutter('kubejs:cutter/sculk_vein')
...
event.recipes.gtceu.cutter('kubejs:cutter/sculk_vein_2')
.itemInputs('minecraft:sculk')
...
event.recipes.gtceu.cutter('kubejs:cutter/sculk_vein_3')
.itemInputs('minecraft:sculk')
...
event.recipes.gtceu.cutter('kubejs:cutter/obsidian_plate')
...
event.recipes.gtceu.cutter('kubejs:cutter/obsidian_plate_2')
.itemInputs('minecraft:obsidian')
.inputFluids(Fluid.of('gtceu:distilled_water', 60))
.itemOutputs('4x gtceu:obsidian_plate')
.duration(600)
...
event.recipes.gtceu.cutter('kubejs:cutter/obsidian_plate_3')
.itemInputs('minecraft:obsidian')
.inputFluids(Fluid.of('gtceu:lubricant', 20))
.itemOutputs('4x gtceu:obsidian_plate')
.duration(400)
...
event.recipes.gtceu.cutter('kubejs:cutter/oak_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/dark_oak_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/spruce_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/birch_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/acacia_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/jungle_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/mangrove_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/cherry_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/bamboo_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/crimson_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/warped_planks')
...
event.recipes.gtceu.cutter('kubejs:cutter/rubber_planks')
