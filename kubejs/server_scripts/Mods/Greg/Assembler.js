...
event.recipes.gtceu.assembler('kubejs:assembler/card_item')
.itemInputs('#forge:dusts/redstone')
.itemInputs('#forge:plates/cobalt')
.itemInputs('#forge:gems/quartz')
.itemInputs('3x #forge:nuggets/gold')
...
event.recipes.gtceu.assembler('kubejs:assembler/card_item_2')
.itemInputs('#forge:dusts/redstone')
.itemInputs('#forge:plates/cobalt')
.itemInputs('#forge:gems/quartz')
.itemInputs('laserio:logic_chip')
...
event.recipes.gtceu.assembler('kubejs:assembler/card_fluid')
.itemInputs('#forge:dusts/redstone')
...
event.recipes.gtceu.assembler('kubejs:assembler/card_fluid_2')
.itemInputs('#forge:dusts/redstone')
.itemInputs('#forge:plates/iron')
.itemInputs('#forge:gems/quartz')
.itemInputs('laserio:logic_chip')
...
event.recipes.gtceu.assembler('kubejs:assembler/card_energy')
.itemInputs('#forge:dusts/redstone')
.itemInputs('#forge:plates/red_alloy')
.itemInputs('#forge:gems/quartz')
.itemInputs('3x #forge:nuggets/gold')
...
event.recipes.gtceu.assembler('kubejs:assembler/card_energy_2')
.itemInputs('#forge:dusts/redstone')
.itemInputs('#forge:plates/red_alloy')
.itemInputs('#forge:gems/quartz')
.itemInputs('laserio:logic_chip')
...
event.recipes.gtceu.assembler('kubejs:assembler/card_redstone')
.itemInputs('#forge:dusts/redstone')
.itemInputs('#forge:foils/red_alloy')
.itemInputs('#forge:gems/quartz')
.itemInputs('3x #forge:nuggets/gold')
.itemInputs('laserio:logic_chip')
.inputFluids(Fluid.of('gtceu:rubber', 144))
...
event.recipes.gtceu.assembler('kubejs:assembler/card_redstone_2')
.itemInputs('#forge:dusts/redstone')
.itemInputs('#forge:foils/red_alloy')
.itemInputs('#forge:gems/quartz')
.itemInputs('laserio:logic_chip')
...
event.recipes.gtceu.assembler('kubejs:assembler/filter_basic')
.itemInputs('4x #forge:rods/iron')
.itemInputs('2x #forge:glass_panes/colorless')
.itemInputs('laserio:logic_chip')
.inputFluids(Fluid.of('gtceu:rubber', 144))
.itemOutputs('6x laserio:filter_basic')
.duration(40)
.EUt(ULV)

// filter_basic_2

event.recipes.gtceu.assembler('kubejs:assembler/filter_basic_2')
.itemInputs('4x #forge:rods/iron')
.itemInputs('2x #forge:glass_panes/colorless')
.itemInputs('laserio:logic_chip')
.inputFluids(Fluid.of('gtceu:polyethylene', 144))
.itemOutputs('8x laserio:filter_basic')
.duration(40)
.EUt(ULV)

// logic_chip

event.recipes.gtceu.assembler('kubejs:assembler/logic_chip')
.itemInputs('2x #forge:dusts/redstone')
.itemInputs('#forge:ingots/clay')
.itemInputs('#forge:storage_blocks/quartz')
.itemInputs('3x #forge:nuggets/gold')
.inputFluids(Fluid.of('gtceu:rubber', 144))
.itemOutputs('6x laserio:logic_chip')
.duration(40)
.EUt(ULV)

// logic_chip_2

event.recipes.gtceu.assembler('kubejs:assembler/logic_chip_2')
.itemInputs('2x #forge:dusts/redstone')
.itemInputs('#forge:ingots/clay')
.itemInputs('#forge:storage_blocks/quartz')
.itemInputs('3x #forge:nuggets/gold')
.inputFluids(Fluid.of('gtceu:polyethylene', 144))
.itemOutputs('8x laserio:logic_chip')
.duration(40)
.EUt(ULV)
...
event.recipes.gtceu.assembler('kubejs:assembler/creative_energy_cell')
.itemInputs('8x ae2:dense_energy_cell')
...
// basic_travel_boots_boots

event.remove ({ output: 'travelboots:basic_travel_boots_boots'})
event.recipes.gtceu.assembler('kubejs:assembler/basic_travel_boots_boots')
.itemInputs('1x minecraft:iron_boots')
.itemInputs('2x gtceu:lv_electric_piston')
.itemInputs('2x gtceu:gold_plate')
.inputFluids(Fluid.of('gtceu:rubber', 288))
.itemOutputs('travelboots:basic_travel_boots_boots')
.duration(200)
.EUt(LV)
