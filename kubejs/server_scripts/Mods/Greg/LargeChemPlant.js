ServerEvents.recipes((event) => {
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/soul_sand')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/soul_soil')
	...
	event.recipes.gtceu
		.large_chemical_reactor(
			'kubejs:large_chemical_reactor/flawless_budding_quartz'
		)
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/bedrock')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/sculk')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/sculk_catalyst')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/sculk_sensor')
		.itemInputs('minecraft:sculk')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/sculk_shrieker')
		.itemInputs('minecraft:sculk')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/crying_obsidian')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/leather')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/moss_block')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/lily_pad')
		.itemInputs('4x gtceu:bio_chaff')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/cobweb')
		.itemInputs('4x gtceu:bio_chaff')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/nether_star_dust')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/elytra')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/uncommon_material')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/rare_material')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/epic_material')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/heart_of_the_sea')
	...
	event.recipes.gtceu
		.large_chemical_reactor('kubejs:large_chemical_reactor/nautilus_shell')
	...
	event.recipes.gtceu
		.large_chemical_reactor(
			'kubejs:large_chemical_reactor/advanced_pressure_valve'
		)
