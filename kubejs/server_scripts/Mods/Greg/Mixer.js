console.info('Greg Mixer: Registering recipes...')
ServerEvents.recipes((event) => {
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/fluix_crystal')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/glowstone_dust')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/skystone_dust')
		.itemInputs('#forge:dusts/certus_quartz')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/pointed_dripstone')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/netherite_scrap')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/grains_of_infinity')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/conduit_binder_composite')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/white_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/orange_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/magenta_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/light_blue_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/yellow_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/lime_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/pink_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gray_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/light_gray_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/cyan_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/purple_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/blue_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/brown_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/green_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/red_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/black_concrete')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/dragon_breath')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/ballast')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/brawlers')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/combatant')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/guardian')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/lightning')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/samurai')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/slipstream')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/splendor')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/tyrannical')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/warlord')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/royalty')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/endersurge')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/mageslayer')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/blood_lord')
	...
	event.recipes.gtceu
		.mixer('kubejs:mixer/gem/inferno')
