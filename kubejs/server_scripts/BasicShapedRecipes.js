ServerEvents.recipes((e) => {
	...
	//Noteblock Crafting
	e.shaped('minecraft:note_block', ['ppp', 'igi', 'prp'], {
		p: 'gtceu:wood_plate',
	...
	//Jukebox Crafting
	e.shaped('minecraft:jukebox', ['lbl', 'nrn', 'lgl'], {
		l: '#minecraft:logs',
		b: 'gtceu:iron_bolt',
	...
	//Dyes
	e.shaped('minecraft:red_dye', ['A  ', 'B  ', '   '], {
		A: '#forge:dusts/redstone',
		B: '#forge:tools/mortars',
	})

	e.shaped('minecraft:black_dye', ['A  ', 'B  ', '   '], {
		A: '#forge:dusts/coal',
		B: '#forge:tools/mortars',
	})
	...
	// lime_wool
	e.shaped('minecraft:lime_wool', ['AA', 'AA'], {
		A: 'ex_hammers:plant_fiber',
	})

	// string
	e.shaped('2x minecraft:string', ['A ', 'B '], {
		A: 'ex_hammers:plant_fiber',
		B: '#forge:tools/knives',
	})

	// grass_seed
	e.shaped('ex_hammers:grass_seed', ['A ', 'B '], {
		A: 'minecraft:wheat_seeds',
		B: '#forge:tools/knives',
	})

	// clay_ball
	e.shaped('3x minecraft:clay_ball', ['A ', 'B '], {
	...
	e.shaped('travelanchors:travel_staff', [' EA', 'DBE', 'FC '], {
	...
	e.shaped('travelanchors:travel_anchor', ['ABA', 'CDC', 'ABA'], {
